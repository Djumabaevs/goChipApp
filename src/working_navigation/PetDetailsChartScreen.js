...
class PetDetailsChartScreen extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                 <SynHeader title="Pet Details Chart" navigation={this.props.navigation} />
                <PetDetailsChart
                  {...this.props}
...
const apolloPetDetailsChartScreen = withApollo(PetDetailsChartScreen);
export default apolloPetDetailsChartScreen;